...
#ifndef HELLOC_UI_SCENE_HPP
#define HELLOC_UI_SCENE_HPP


#include "core/ascii_to_geom.hpp"
...
public:
    ...
    void
    Render(TrivialShader *trivialShader, TextRenderer *textRenderer, ShapeRenderer *shapeRenderer,
           int focus, float transitionFactor);
};

#endif //HELLOC_UI_SCENE_HPP
