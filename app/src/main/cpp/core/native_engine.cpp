...
NativeEngine::NativeEngine(struct android_app* app) {
    ...
    mChannel = grpc::CreateChannel("192.168.0.3:9090", grpc::InsecureChannelCredentials());
...
std::shared_ptr<grpc::Channel> NativeEngine::GetChannel() {
    return mChannel;
}
    ...
    switch (cmd) {
        ...
        case APP_CMD_INIT_WINDOW:
            ...
            if (mApp->window != NULL) {
                ...
                // *** THIS IS THE FIX ***
                // Initialize our singletons that need the AAssetManager here.
                // This MUST be done before any code tries to load assets.
                AssetManager::GetInstance().Init(mApp->activity->assetManager);
